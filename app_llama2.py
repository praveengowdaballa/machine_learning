...
def setup_page():
    ...
    st.markdown("<h2 style='text-align: center; color: white;'>CCoE Chat Bot Any file format </h2>", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            ...
            <a href="%s">The CCoE Chat Bot By Prveen HA</a>  
            </div>
...
def get_environment_variables():
    model = os.environ.get("MODEL", "llama2:latest")  # Set to Llama 2 model
